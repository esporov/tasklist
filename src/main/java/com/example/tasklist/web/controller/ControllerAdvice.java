...
public class ControllerAdvice {
    ...
    //если не совпадают пароли или пользователь не зарегистрирован
    @ExceptionHandler(IllegalStateException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ExceptionBody handleResourceNotMapping(IllegalStateException e) {
        return new ExceptionBody(e.getMessage());
    }


    //не подходит токен или не прошла авторизация
    ...
    public ExceptionBody handleArgumentNotValid(MethodArgumentNotValidException e) {
        var exceptionBody = new ExceptionBody("Validation error");
    ...
    public ExceptionBody handleConstraintViolationException(ConstraintViolationException e) {
        var exceptionBody = new ExceptionBody("Validation field");
